...
<<<<<<< HEAD
    ...
    modules: 12,
    rating: 4.8,
    videoUrl: 'https://www.youtube.com/embed/kopoLzvh5jY',
    transcript: 'Newton\'s laws of motion are three physical laws that, together, laid the foundation for classical mechanics. They describe the relationship between a body and the forces acting upon it, and its motion in response to those forces.',
    summary: 'This lesson covers the fundamentals of Newton\'s laws, including Inertia (First Law), F=ma (Second Law), and Action/Reaction (Third Law).'
  },
  {
    id: '3',
