  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
        <div className="relative flex-1 w-full max-w-xl">
          ...
          <input
            ...
            className="w-full pl-16 pr-6 py-5 bg-white border border-slate-100 rounded-xl text-sm font-medium focus:outline-none focus:ring-4 focus:ring-blue-900/5 focus:border-blue-900/20 transition-all shadow-sm"
          />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 pb-20">
        {MOCK_BOOKS.map((book) => (
          <div key={book.id} className="group bg-white rounded-xl border border-slate-100 hover:border-blue-900/20 overflow-hidden hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-700">
            {/* Book Representation */}
            <div className="relative h-64 bg-slate-50 flex items-center justify-center p-10 overflow-hidden">
              ...
              <div className="relative w-40 h-52 transition-transform duration-700 group-hover:scale-110 group-hover:rotate-3">
                ...
                <div className="absolute inset-0 bg-white rounded-r-xl shadow-2xl overflow-hidden border-l-8 border-slate-900 border-y border-r border-slate-100">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="text-[10px] font-black text-blue-900 uppercase tracking-tighter drop-shadow-md">NIOS DIGITAL</div>
                  </div>
                </div>
                {/* Page Edges */}
              ...
              <div className="absolute top-6 right-6 px-3 py-1 bg-white/90 backdrop-blur-md rounded-lg text-[8px] font-black uppercase tracking-widest text-blue-900 border border-blue-100 shadow-sm">
                {book.category}
              </div>
            </div>

            <div className="p-10">
              <h3 className="text-xl font-black text-slate-900 mb-2 leading-tight group-hover:text-blue-900 transition-colors">
                {book.title}
              </h3>
              ...
              <div className="flex items-center gap-6 mb-10 text-[10px] font-black text-slate-500 uppercase tracking-widest">
                ...
                <div className="flex items-center gap-2">
                  <Star size={14} className="text-blue-400" fill="currentColor" /> 4.9 Rating
                </div>
              </div>

              <Link
                href={book.category === 'Schedule' ? '/library/books' : '#'}
                className="flex items-center justify-center gap-3 w-full py-5 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-blue-900 transition-all shadow-xl active:scale-95"
              >
        ...
        <div className="lg:col-span-3 mt-10 p-12 rounded-xl bg-gradient-to-br from-blue-900 to-blue-600 text-white relative overflow-hidden group">
          ...
          <div className="relative z-10 grid md:grid-cols-[1fr_auto] items-center gap-10">
            <div className="space-y-6">
              <h2 className="text-4xl font-black leading-tight tracking-tighter">Your AI-Poweblue <br />LMS Learning Core</h2>
              ...
              <button className="px-10 py-5 bg-white text-blue-900 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-black hover:text-white transition-all shadow-2xl">
                Request Resources
              </button>
            </div>
