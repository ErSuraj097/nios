    ...
    >
        <div className="p-6 space-y-6">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                    <p className="text-sm uppercase tracking-[0.3em] text-orange-600 font-semibold mb-2">
                        Student Finance
                    </p>
            ...
            <div className="grid gap-4 md:grid-cols-3">
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <p className="mt-3 text-3xl font-bold text-orange-600 flex"><IndianRupeeIcon/> 1,250</p>
                        ...
                        <div className="space-y-3">
                            <div className="rounded-xl border border-slate-200 p-5">
                                <div className="flex items-center justify-between">
                                    ...
                                    <p className="font-semibold text-orange-600">-$120.00</p>
                                </div>
                            </div>
                            <div className="rounded-xl border border-slate-200 p-5">
                                <div className="flex items-center justify-between">
                                    ...
                                    <p className="font-semibold text-orange-600">-$45.00</p>
                                </div>
                            </div>
                            <div className="rounded-xl border border-slate-200 p-5">
                                <div className="flex items-center justify-between">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="rounded-xl border border-slate-200 bg-slate-50 p-6">
                            <div className="flex items-center justify-between">
                                ...
                                <p className="rounded-full bg-orange-100 px-3 py-1 text-sm font-semibold text-orange-700">
                                    72% used
                                </p>
                            </div>
                            <div className="mt-4 h-3 rounded-full bg-slate-200">
                                <div className="h-3 rounded-full bg-orange-600" style={{ width: '72%' }} />
                            </div>
                        </div>
                        <div className="grid gap-4 md:grid-cols-3">
                            <div className="rounded-xl bg-white p-5 shadow-sm">
