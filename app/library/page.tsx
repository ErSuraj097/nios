  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
        <div className="relative flex-1 w-full max-w-xl">
          ...
          <input 
            ...
            className="w-full pl-16 pr-6 py-5 bg-white border border-slate-100 rounded-[2.5rem] text-sm font-medium focus:outline-none focus:ring-4 focus:ring-brand-orange/5 focus:border-brand-orange/20 transition-all shadow-sm"
          />
        </div>
        <div className="flex items-center gap-3">
          <button className="px-8 py-5 bg-white border border-slate-100 rounded-[2rem] text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-slate-900 transition-all flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 pb-20">
        {MOCK_BOOKS.map((book) => (
          <div key={book.id} className="group bg-white rounded-[3.5rem] border border-slate-100 hover:border-brand-orange/20 overflow-hidden hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-700">
            {/* Book Representation */}
              ...
              <div className="relative w-40 h-52 transition-transform duration-700 group-hover:scale-110 group-hover:rotate-3">
                 ...
                 <div className="absolute inset-0 bg-white rounded-r-xl shadow-2xl overflow-hidden border-l-8 border-slate-900 border-y border-r border-slate-100">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                       <div className="text-[10px] font-black text-white uppercase tracking-tighter drop-shadow-md">NIOS DIGITAL</div>
                    </div>
                 </div>
                 {/* Page Edges */}
            ...
            <div className="p-10">
              ...
              <Link 
                href={book.category === 'Schedule' ? '/schedule/interactive' : '#'}
                className="flex items-center justify-center gap-3 w-full py-5 bg-slate-900 text-white rounded-[2rem] font-black text-[10px] uppercase tracking-widest hover:bg-brand-orange transition-all shadow-xl active:scale-95"
              >
        ...
        <div className="lg:col-span-3 mt-10 p-12 rounded-[4rem] bg-gradient-to-br from-brand-orange to-red-600 text-white relative overflow-hidden group">
           ...
           <div className="relative z-10 grid md:grid-cols-[1fr_auto] items-center gap-10">
              <div className="space-y-6">
                 ...
                 <button className="px-10 py-5 bg-white text-brand-orange rounded-[2rem] font-black text-xs uppercase tracking-widest hover:bg-black hover:text-white transition-all shadow-2xl">
                    Request Resources
                 </button>
              </div>
              <div className="hidden md:block w-64 h-64 bg-white/10 backdrop-blur-2xl rounded-[3rem] border border-white/20 flex items-center justify-center rotate-6 group-hover:rotate-12 transition-transform duration-700">
