  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-10">
        <div className="relative flex-1 w-full max-w-md">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-4 bg-white border border-slate-100 rounded-xl text-sm focus:outline-none focus:ring-4 focus:ring-blue-900/5 focus:border-blue-900/20 transition-all shadow-sm"
          />
        </div>
          ...
          <div key={course.id} className="group bg-white rounded-xl border border-slate-100 overflow-hidden hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-500">
            <div className="relative h-48 bg-slate-100 overflow-hidden">
              ...
              <div className="absolute inset-0 flex items-center justify-center group-hover:scale-110 transition-transform duration-700">
                {/* <course.icon size={64} className="text-slate-200 group-hover:text-blue-900/20 transition-colors" /> */}
              ...
              <div className="absolute bottom-4 left-4 z-20 flex gap-2">
                ...
                <span className="px-3 py-1 backdrop-blur-md rounded-lg text-[10px] font-black uppercase tracking-widest text-white border border-white/20 bg-emerald-500/80">
                  {course.currentStage.toUpperCase()}
                </span>
            ...
            <div className="p-8">
              <h3 className="text-xl font-black text-slate-900 mb-4 leading-tight group-hover:text-blue-900 transition-colors">
                {course.title}
              </h3>
              ...
              {isLearner && course.enrolled ? (
                <div className="space-y-4">
                  ...
                  <Link
                    ...
                    className="flex items-center justify-center gap-2 w-full py-4 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-blue-900 transition-all shadow-lg active:scale-95"
                  >
                ...
                <div className="flex items-center justify-between mt-auto pt-6 border-t border-slate-50">
                  ...
                  <button className="px-6 py-3 bg-blue-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-blue-600 transition-all shadow-lg shadow-blue-500/20 active:scale-95">
                    Enroll Now
                  </button>
                </div>
              )}
      ...
      <div className="mt-16 p-12 rounded-xl bg-blue-50 border border-slate-200 shadow-2xl relative overflow-hidden group">
        ...
        <div className="absolute top-0 right-0 w-96 h-96 bg-blue-900/10 rounded-full blur-[100px] -mr-32 -mt-32 group-hover:scale-125 transition-transform duration-1000 border border-blue-900/5" />
        <div className="relative  z-10 max-w-2xl">


          <div className="w-16 h-16 rounded-xl bg-blue-900/20 flex items-center justify-center text-blue-900 mb-8 group-hover:scale-110 transition-transform">
            <Sparkles size={32} />
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            <button className="px-8 py-4 bg-blue-900 text-white rounded-xl font-black text-xs uppercase tracking-widest hover:bg-blue-600 transition-all shadow-xl shadow-blue-500/20 active:scale-95">
              Ask AI Assistant
            </button>
