<<<<<<< HEAD
  ...
  //                 {groups.map((g) => (
  //                   <button key={g.id} className="w-full p-4 rounded-xl flex items-center gap-4 hover:bg-orange-50 transition-all text-left group">
  ...
  //                 <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center font-black text-white text-lg shrink-0 shadow-lg">
  //                     {user.name.charAt(0)}
  //                 </div>
  //                 <textarea 
  ...
  //                     ))}
  //                 </div>
  //                 <button className="px-10 py-4 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-brand-orange transition-all shadow-xl shadow-slate-200 active:scale-95 flex items-center gap-2">
  ...
  //                   ].map((w, i) => (
  //                       <div key={i} className="p-8 rounded-xl bg-white border border-slate-100 hover:border-brand-orange/20 transition-all group">
  //                         <div className="flex items-center justify-between mb-6">
  //                             <div className="w-12 h-12 rounded-xl bg-slate-50 text-slate-400 flex items-center justify-center group-hover:bg-brand-orange group-hover:text-white transition-all">
  //                               <FileCode size={20} />
  //                             </div>
  ...
  //                         <button className="w-full py-4 bg-slate-50 hover:bg-brand-orange hover:text-white text-slate-900 rounded-xl font-black text-[10px] uppercase tracking-widest transition-all">Launch Workspace</button>
  //                       </div>
  //                   ))}
  //                 </div>
  //               ) : (
  //                 feeds.map((f) => (
  //                   <div key={f.id} className="group p-8 rounded-xl bg-white border border-slate-100 hover:border-brand-orange/20 hover:shadow-2xl hover:shadow-slate-200/50 transition-all flex flex-col gap-6 relative overflow-hidden">
  ...
  //               <div className="absolute top-0 right-0 w-32 h-32 bg-brand-orange/20 rounded-full blur-3xl group-hover:scale-150 transition-all duration-1000" />
  ...
  //                 </div>
  //                 <button className="w-full py-4 bg-brand-orange hover:bg-orange-600 text-white rounded-xl font-black text-[10px] uppercase tracking-widest transition-all shadow-lg shadow-orange-500/20 active:scale-95">
  //                     Launch AI Chatbot
  //                 </button>
  //               </div>
  //           </div>
            ...
            // {/* Featured Blog CTA */}
            // <div className="p-10 rounded-xl  bg-gradient-to-br from-amber-200 to-orange-400 text-white relative overflow-hidden group">
            ...
            //       </div>
            //     </div>
            //     <button className="w-full mt-6 py-4 bg-brand-orange text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-orange-600 transition-all shadow-xl shadow-orange-500/20">Explore Library</button>
            // </div>
            ...
            //             </div>
            //             <button className="w-full py-4 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-brand-orange transition-all shadow-sm flex items-center justify-center gap-2">
            ...
            // {/* Support Map */}
            // <div className="p-10 rounded-xl bg-gradient-to-br from-orange-50 to-white border border-orange-100 shadow-sm text-center">
            //     <Map className="w-10 h-10 mx-auto mb-4 text-orange-500 opacity-50" />
            ...
            //     <button className="w-full py-4 bg-white border border-orange-100 text-orange-600 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-orange-50 transition-all shadow-lg shadow-orange-500/10">Start Orientation</button>
            // </div>
  //         </div>
  //       </div>
  //     </DashboardLayout>
...
<<<<<<< HEAD
                <button key={i} className="w-full p-4 rounded-xl flex items-center gap-4 hover:bg-orange-50 transition-all text-left">
=======
...
<<<<<<< HEAD
            <div className="p-10 rounded-xl  bg-gradient-to-br from-amber-200 to-orange-400 text-white relative overflow-hidden group">
                ...
                <Link href="/library">
                <button className="w-full mt-6 py-4 bg-brand-orange text-white rounded-xl font-black text-[10px] uppercase tracking-widest
                 hover:bg-orange-600 transition-all shadow-xl shadow-orange-500/20">
...
>>>>>>> main
            ...
            <div className="flex items-center justify-between pt-6 border-t border-slate-50">
              <div className="flex gap-2">
<<<<<<< HEAD
                <label className="p-3 bg-slate-50 text-slate-400 hover:text-brand-orange hover:bg-orange-50 rounded-xl transition-all cursor-pointer">
                  <ImageIcon size={18} />
                  <input type="file" accept="image/*" className="hidden" onChange={handleImageUpload} />
                </label>
                <button className="p-3 bg-slate-50 text-slate-400 hover:text-brand-orange hover:bg-orange-50 rounded-xl transition-all">
                  <Video size={18} />
                </button>
              </div>
              <button 
                ...
                className="px-10 py-4 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-brand-orange transition-all shadow-xl shadow-slate-200 active:scale-95 disabled:opacity-50 flex items-center gap-2"
=======
...
<<<<<<< HEAD
                  <div className={`max-w-[75%] rounded-2xl px-4 py-3 text-sm ${msg.isOwn ? 'bg-brand-orange text-white' : 'bg-slate-100'}`}>
=======
...
<<<<<<< HEAD
                className="flex-1 px-5 py-4 border border-slate-200 rounded-2xl focus:outline-none focus:border-brand-orange text-sm"
              />
              <button 
                onClick={sendChatMessage}
                className="px-6 bg-brand-orange hover:bg-orange-600 text-white rounded-2xl flex items-center justify-center transition-all active:scale-95"
=======
