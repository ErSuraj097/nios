    ...
    <DashboardLayout title="Exam Management" subtitle="Create exams, upload questions, generate question papers & setup proctoring">
      <div className="space-y-10">
        ...
        <div className="flex flex-wrap gap-3 bg-white/50 backdrop-blur-sm p-4 rounded-xl border border-slate-100/50">
          ...
          <button onClick={() => setActiveTab('questions')} className={`px-6 py-3 rounded-xl font-black text-sm uppercase tracking-widest ${activeTab === 'questions' ? 'bg-brand-orange text-white shadow-lg' : 'text-slate-500 hover:text-slate-900'}`}>
            Questions Bank
          </button>
            ...
            <div className="flex items-center gap-4">
              <div className="relative flex-1">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-6 py-4 bg-white/50 backdrop-blur-sm rounded-xl border border-slate-200 shadow-sm focus:ring-4 focus:ring-brand-orange/20 focus:outline-none transition-all"
                />
              </div>
