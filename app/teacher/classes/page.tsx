      ...
      <div className="space-y-10 animate-fade-in">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-center justify-between">
           <div className="flex items-center gap-6">
              ...
              <div className="h-10 w-px bg-orange-900 hidden md:block" />
        ...
        <div className="space-y-6">
           ...
           <div className="grid gap-6">
              {classes.map((cls) => (
                <div key={cls.id} className="group p-8 rounded-xl bg-white border border-slate-100 hover:border-brand-orange/20 hover:shadow-2xl hover:shadow-slate-200/50 transition-all flex flex-col lg:flex-row items-center gap-10">
                   <div className="w-20 h-20 rounded-xl bg-orange-50 text-brand-orange flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform shadow-sm">
                      <Video size={32} />
                   </div>
                   ...
                   <div className="flex gap-3">
                      <button className="px-8 py-4 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-brand-orange transition-all shadow-xl active:scale-95 flex items-center gap-2">
