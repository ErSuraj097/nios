            ...
            <div key={report.id} className="group p-10 rounded-xl bg-white border-2 border-slate-100 hover:border-brand-orange hover:shadow-2xl hover:shadow-orange-500/10 transition-all overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center gap-8">
                <div className="flex items-center gap-4 flex-shrink-0">
                  <div className="w-14 h-14 bg-gradient-to-br from-orange-400 to-red-400 text-white rounded-xl flex items-center justify-center shadow-2xl group-hover:scale-110 transition-all">
                    <FileText size={28} />
                  </div>
                  <div>
