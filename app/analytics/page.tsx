...
<div className="p-8 rounded-xl bg-white border border-slate-100 shadow-sm overflow-hidden group hover:shadow-2xl transition-all duration-300">
  <div className="flex items-center justify-between mb-8">
    <div className="flex items-center gap-3">
      <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-orange-500 via-red-500 to-rose-500 text-white flex items-center justify-center shadow-inner">
        <BarChart3 size={22} />
      </div>
      <div>
    ...
    <div className="flex gap-2 text-xs">
      <button className="px-5 py-2 bg-orange-500 text-white font-black rounded-xl shadow-sm hover:bg-orange-600 transition-all active:scale-95">
        7 Days
      </button>
    ...
    <div className="text-emerald-600">Peak: Sat ({Math.max(...weeklyActivity.map(d => d.hours))}h)</div>
             ...
             <div className="p-8 rounded-xl bg-white border border-slate-100 shadow-sm transition-all hover:shadow-xl group">
                ...
                <div className="flex items-end justify-center gap-4 h-48 pt-8">
                   {[
                      ...
                      { level: 'Medium', h: '65%', color: 'bg-amber-400' },
                      { level: 'Hard', h: '42%', color: 'bg-red-400' },
                   ].map((d, i) => (
        ...
        <div className="space-y-8">
           ...
           <div className="p-8 rounded-xl bg-white border border-slate-100 shadow-sm overflow-hidden">
             ...
             <button className="w-full mt-10 py-4 bg-slate-50 border border-slate-100 text-slate-500 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-orange-400 hover:text-white   transition-all text-center">
                Career Roadmap
             </button>
           </div>

           <div className="p-8 rounded-xl bg-gradient-to-br from-amber-50 to-white border border-indigo-100 shadow-sm overflow-hidden relative group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-amber-500/5 rounded-full blur-3xl group-hover:scale-150 transition-all duration-1000" />
              <Dna className="mx-auto mb-6 text-orange-500 opacity-50 group-hover:rotate-45 transition-transform" size={40} />
              ...
              <button className="w-full py-4 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-orange-600 transition-all shadow-xl active:scale-95 flex items-center justify-center gap-2">
