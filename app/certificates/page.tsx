      ...
      <div className="grid lg:grid-cols-[1fr_360px] gap-8 items-start animate-fade-in pb-20">
        ...
        <div className="space-y-10">
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between px-4">
            ...
            <div className="flex gap-2">
              ...
              <button 
                ...
                className="px-8 py-4 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-brand-orange transition-all shadow-xl flex items-center gap-2"
              >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {mockCertificates.map((cert) => (
              <div 
                key={cert.id} 
                className="group p-8 rounded-xl bg-white border border-slate-100 hover:border-brand-orange/20 hover:shadow-2xl hover:shadow-slate-200/50 transition-all relative overflow-hidden"
              >
                <div className="flex items-start justify-between mb-8">
                  <div className="w-14 h-14 rounded-xl bg-slate-50 text-slate-400 flex items-center justify-center shrink-0 group-hover:bg-brand-orange group-hover:text-white transition-all shadow-sm">
                    <GraduationCap size={24} />
                  </div>
                   <div className="flex flex-col items-end gap-1">
                      <div className={`text-[8px] font-black uppercase tracking-widest px-2 py-1 rounded-lg border flex items-center gap-1 ${
                      ...
                      <div className="text-[7px] font-black text-amber-500 uppercase tracking-widest flex items-center gap-1">
                ...
                <div className="flex items-center gap-2 mb-8 p-4 bg-amber-50 rounded-xl border border-slate-100 border-dashed">
                ...
                <div className="flex gap-2">
                  <button 
                    ...
                    className="flex-[2] py-4 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-brand-orange transition-all shadow-xl active:scale-95 flex items-center justify-center gap-2"
                  >
        ...
        <div className="space-y-8">
          ...
          <div className="p-10 rounded-xl bg-white border border-slate-100 shadow-sm text-center group">
            <div className="w-20 h-20 mx-auto mb-6 rounded-xl bg-gradient-to-br from-brand-orange to-red-500 text-white font-black text-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
              {user.name.charAt(0)}
            </div>
             ...
             <div className="grid grid-cols-3 gap-4 border-t border-slate-50 pt-8">
              ...
              <div className="text-center">
                <button className="flex flex-col items-center gap-1 group/btn">
                   <div className="w-8 h-8 rounded-lg bg-orange-50 text-brand-orange flex items-center justify-center group-hover/btn:bg-brand-orange group-hover/btn:text-white transition-all">
          ...
          <div className="p-10 rounded-xl bg-slate-900 text-white relative overflow-hidden group">
            ...
            <button className="w-full py-4 bg-white text-slate-900 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-brand-orange hover:text-white transition-all shadow-xl">
              Connect DigiLocker
            </button>
          </div>

          {/* Quick Verify */}
          <div className="p-10 rounded-xl bg-gradient-to-br from-amber-50 to-white border border-blue-100 shadow-sm text-center group">
            <Sparkles className="w-10 h-10 mx-auto mb-6 text-orange-500 opacity-50 group-hover:rotate-12 transition-transform" />
            ...
            <button className="w-full py-4 bg-white border border-blue-100 text-orange-600 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-blue-50 transition-all shadow-lg shadow-blue-500/10">
              Platform Registry
            </button>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl max-w-4xl w-full max-h-[80vh] overflow-hidden shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 p-6 border-t bg-white">
              <button 
                ...
                className="flex-1 py-4 bg-slate-600 hover:bg-red-700 text-white rounded-xl font-black text-sm uppercase tracking-widest transition-all flex items-center justify-center gap-2"
              >
                <Download size={20} />
                Download Certificate
              </button>
              ...
              <button 
                ...
                className="flex-1 py-4 bg-orange-600 hover:bg-orange-700 text-white rounded-xl font-black text-sm uppercase tracking-widest transition-all flex items-center justify-center gap-2"
              >
                <Share2 size={20} />
                Share Certificate
              </button>
                   ...
                   <div className="space-y-6">
                      <div className="relative">
                         <input 
                           ...
                           className="w-full px-6 py-5 bg-slate-50 border border-slate-100 rounded-xl text-xs font-medium focus:ring-2 focus:ring-brand-orange/20 transition-all text-center"
                           value={verifyingHash}
                      ...
                      <button 
                        ...
                        className="w-full py-5 bg-slate-900 text-white rounded-xl font-black text-xs uppercase tracking-widest hover:bg-brand-orange transition-all shadow-xl disabled:opacity-50"
                      >
