    ...
    <DashboardLayout title="Automated Notifications" subtitle="Class reminders, pending approvals, deadlines and targeted messaging">
      <div className="space-y-8">
        ...
        <div className="bg-slate-50 p-1 rounded-xl border flex">
          ...
          <button onClick={() => setTab('history')} className={`px-8 py-3 rounded-lg font-black uppercase tracking-widest flex-1 text-xs transition-all ${
            tab === 'history' ? 'bg-emerald-500 text-white shadow-sm' : 'text-slate-500 hover:text-slate-900'
          }`}>
            Sent History
          </button>
