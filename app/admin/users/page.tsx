...
<<<<<<< HEAD
          ...
          <button onClick={() => setActiveTab('bulk')} className={`px-8 py-4 rounded-xl font-black uppercase tracking-widest flex-1 ${activeTab === 'bulk' ? 'bg-brand-orange text-white shadow-lg' : 'text-slate-600 hover:text-slate-900'}`}>
            Bulk Onboard
          </button>
