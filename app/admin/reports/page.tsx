      ...
      <div className="space-y-10 animate-fade-in pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 p-12 rounded-2xl bg-white border border-slate-100 shadow-sm relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-64 h-64 bg-orange-50 rounded-full blur-3xl group-hover:scale-150 transition-all duration-1000" />
            
            <div className="flex flex-col md:flex-row items-center gap-10">
              <div className="w-20 h-20 rounded-2xl bg-orange-50 text-orange-500 flex items-center justify-center shrink-0 shadow-sm">
                <TrendingUp size={32} />
              </div>
          ...
          <div className="p-10 rounded-2xl bg-slate-900 text-white flex flex-col justify-between group relative overflow-hidden">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="w-12 h-12 rounded-2xl bg-white/10 flex items-center justify-center text-orange-400 shadow-inner">
                <ShieldCheck size={20} />
              </div>
              <div className="text-[10px] font-black text-orange-400 uppercase tracking-widest px-3 py-1 bg-orange-500/10 rounded-full">
                Compliance Active
              </div>
            </div>
