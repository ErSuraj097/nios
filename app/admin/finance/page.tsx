...
<<<<<<< HEAD
          { label: 'Pending Invoices', value: '342', icon: FileText, change: '-5.2%', color: 'text-amber-500', bg: 'bg-amber-50' },
...
<<<<<<< HEAD
                    <div className="font-bold text-slate-900 text-sm group-hover:text-brand-orange transition-colors">{inv.id}</div>
=======
...
<<<<<<< HEAD
                  ...
                  <td className="px-6 py-4 text-right">
                    <span className={`inline-flex items-center px-2.5 py-1 rounded-md text-[10px] font-black uppercase tracking-widest ${
                      ...
                      inv.status === 'Failed' ? 'bg-red-50 text-red-600' : 'bg-amber-50 text-amber-600'
                    }`}>
=======
                    <div className="flex items-center gap-2 text-xs font-bold text-slate-600">
                      {inv.method.includes('UPI') ? <Smartphone size={14} className="text-purple-500" /> :
