      ...
      <div className="space-y-12 animate-fade-in pb-20">
        ...
        <div className="p-12 rounded-[4rem] bg-slate-900 border border-slate-800 shadow-2xl relative overflow-hidden group">
           ...
           <div className="relative space-y-8">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                 <Link href="/login" className="px-10 py-5 bg-white text-slate-900 rounded-[2rem] font-black text-[10px] uppercase tracking-widest hover:bg-brand-orange hover:text-white transition-all shadow-xl active:scale-95 flex items-center gap-3">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
           {[
             ...
             { label: 'Courses Offered', value: '850+', icon: BookOpen, color: 'text-emerald-500 bg-emerald-50' },
              ...
              {featuredCourses.map((c) => (
                <div key={c.id} className="group p-10 rounded-[3rem] bg-white border border-slate-100 hover:border-brand-orange/20 hover:shadow-2xl hover:shadow-slate-200/50 transition-all text-center relative overflow-hidden">
                   ...
                   <div className="flex items-center justify-center gap-6 pt-8 border-t border-slate-50 text-[10px] font-black text-slate-500 uppercase tracking-widest">
                      ...
                      <span className="text-brand-orange">★ {c.rating}</span>
                   </div>
                </div>
              ))}
           </div>
        ...
        <div className="p-12 rounded-[4rem] bg-white border border-slate-100 shadow-sm relative overflow-hidden group">
           ...
           <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="flex-1 text-center lg:text-left">
                 <h3 className="text-2xl font-black text-slate-900 mb-4 uppercase tracking-tight">Predictive AI Tutoring</h3>
              ...
              <button className="px-10 py-5 bg-slate-900 text-white rounded-[2rem] font-black text-[10px] uppercase tracking-widest hover:bg-brand-orange transition-all shadow-xl shadow-slate-200">
                 Trial Learning Hub
              </button>
           </div>
        </div>
