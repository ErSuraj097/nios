               ...
               <div className="lg:col-span-2 space-y-8">
                  ...
                  <div className="grid gap-4">
                     {nextLessons.map((lesson, i) => (
                        <div key={i} className="group p-8 rounded-xl bg-white border border-slate-100 hover:border-blue-900/20 hover:shadow-2xl hover:shadow-slate-200/50 transition-all flex flex-col md:flex-row items-center gap-10">
               ...
               <div className="space-y-8">
                  ...
                  <div className="p-10 rounded-xl bg-white border border-slate-100 shadow-sm space-y-8">
                     ...
                     <div className="pt-6 border-t border-slate-50">
                        <button className="w-full py-4 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-xl hover:bg-blue-900 transition-all">
