...
<<<<<<< HEAD
  ...
  { icon: ClipboardList, label: 'Pending TMAs', value: '38', change: '12 overdue', up: false, color: 'from-orange-500 to-red-600' },
...
<<<<<<< HEAD
                        <div className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center font-black text-slate-500 text-sm group-hover:bg-brand-orange group-hover:text-white transition-colors">
=======
...
>>>>>>> main
                    ...
                    <td className="px-6 py-5">
<<<<<<< HEAD
                      <span className={`px-2.5 py-0.5 rounded-md text-[10px] font-black tracking-widest uppercase ${
                        s.risk === 'high' ? 'bg-red-50 text-brand-red' : s.risk === 'medium' ? 'bg-amber-50 text-amber-600' : 'bg-emerald-50 text-emerald-600'
                      }`}>
=======
...
<<<<<<< HEAD
                      <button className="text-[10px] font-black text-slate-400 hover:text-brand-orange uppercase tracking-tight">Profile</button>
=======
