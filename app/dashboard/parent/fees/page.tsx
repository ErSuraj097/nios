      ...
      <div className="space-y-12 animate-fade-in pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
           <div className="lg:col-span-2 p-12 rounded-xl] bg-white border border-slate-100 shadow-sm relative overflow-hidden group">
              ...
              <div className="flex flex-col md:flex-row items-center gap-10">
                 <div className="w-20 h-20 rounded-xl bg-orange-50 text-brand-orange flex items-center justify-center shrink-0 shadow-sm">
                    <CreditCard size={32} />
                 </div>
        ...
        <div className="space-y-8">
           ...
           <div className="grid gap-4">
              {fees.map((f) => (
                <div key={f.id} className="group p-8 rounded-xl bg-white border border-slate-100 hover:border-brand-orange/20 hover:shadow-2xl hover:shadow-slate-200/50 transition-all flex flex-col lg:flex-row items-center gap-10">
                   ...
                   <div className="flex items-center gap-6">
                      ...
                      <button className={`px-10 py-5 rounded-xl font-black text-[10px] uppercase tracking-widest transition-all shadow-xl active:scale-95 flex items-center gap-3 ${
        ...
        <div className="p-10 rounded-xl bg-white border border-slate-100 shadow-sm relative overflow-hidden group">
           ...
           <div className="flex flex-col lg:flex-row items-center gap-10">
              <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center shrink-0 shadow-xl shadow-orange-500/20">
