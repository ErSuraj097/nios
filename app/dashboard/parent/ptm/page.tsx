...
<<<<<<< HEAD
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
            {MOCK_PTM_SCHEDULE.map((slot) => (
              <div key={slot.id} className={`group p-8 rounded-2xl border-2 transition-all overflow-hidden h-full ${
                ...
                <div className="flex items-start justify-between mb-6">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-orange-400 to-emerald-400 flex items-center justify-center text-white shadow-lg flex-shrink-0">
                    <User size={20} />
                  </div>
